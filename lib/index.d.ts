...
type GetManyApiHandlerConfig<DISPATCHER_OPTIONS, QUERY_ZOD extends AnyZodObject, FIELD_REQUEST> = {
    queryZod: QUERY_ZOD;
...
type GetOneApiHandlerConfig<DISPATCHER_OPTIONS, PARAMS_ZOD extends AnyZodObject, FIELD_REQUEST> = {
    paramsZod: PARAMS_ZOD;
    apiExecutor: GetOneApiExecutor<z.infer<PARAMS_ZOD>, FIELD_REQUEST>;
    authenticator: Authenticator<DISPATCHER_OPTIONS>;
    options?: DISPATCHER_OPTIONS;
};
type CreateOneApiHandlerConfig<DISPATCHER_OPTIONS, BODY_ZOD extends AnyZodObject, FIELD_REQUEST> = {
    bodyZod: BODY_ZOD;
    apiExecutor: CreateOneApiExecutor<z.infer<BODY_ZOD>, FIELD_REQUEST>;
    authenticator: Authenticator<DISPATCHER_OPTIONS>;
    options?: DISPATCHER_OPTIONS;
};
type UpdateOneApiHandlerConfig<DISPATCHER_OPTIONS, PARAMS_ZOD extends AnyZodObject, BODY, FIELD_REQUEST> = {
    paramsZod: PARAMS_ZOD;
...
declare function handleGetMany<DISPATCHER_OPTIONS, QUERY_ZOD extends AnyZodObject, FIELD_REQUEST>(config: GetManyApiHandlerConfig<DISPATCHER_OPTIONS, QUERY_ZOD, FIELD_REQUEST>): (request: Request) => Promise<Response>;
declare const handleSearch: typeof handleGetMany;
declare function handleGetOne<DISPATCHER_OPTIONS, PARAMS_ZOD extends AnyZodObject, FIELD_REQUEST>(config: GetOneApiHandlerConfig<DISPATCHER_OPTIONS, PARAMS_ZOD, FIELD_REQUEST>): (request: Request) => Promise<Response>;
declare function handleCreateOne<DISPATCHER_OPTIONS, BODY_ZOD extends AnyZodObject, FIELD_REQUEST>(config: CreateOneApiHandlerConfig<DISPATCHER_OPTIONS, BODY_ZOD, FIELD_REQUEST>): (request: Request) => Promise<Response>;
declare function handleUpdateOne<DISPATCHER_OPTIONS, PARAMS_ZOD extends AnyZodObject, BODY, FIELD_REQUEST>(config: UpdateOneApiHandlerConfig<DISPATCHER_OPTIONS, PARAMS_ZOD, BODY, FIELD_REQUEST>): (request: Request) => Promise<Response>;
...
export { Authenticator, CreateOneApiExecutor, CreateOneApiHandlerConfig, GetManyApiExecutor, GetManyApiHandlerConfig, GetOneApiExecutor, GetOneApiHandlerConfig, UpdateOneApiExecutor, UpdateOneApiHandlerConfig, dispatch, getMax, getMin, handleCreateOne, handleDeleteOne, handleGetMany, handleGetOne, handleSearch, handleUpdateOne, };
