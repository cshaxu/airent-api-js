...
exports.handleUpdateOne = exports.handleSearch = exports.handleGetOneSafe = exports.handleGetOne = exports.handleGetMany = exports.handleDeleteOne = exports.handleCreateOne = exports.handle = void 0;
...
function handle(config) {
    var _this = this;
    var _a, _b, _c, _d;
    var authenticator = config.authenticator, options = config.options, code = config.code;
    var parserWrapper = (_a = config.parserWrapper) !== null && _a !== void 0 ? _a : (function (f) { return f; });
    var executorWrapper = (_b = config.executorWrapper) !== null && _b !== void 0 ? _b : (function (f) { return f; });
    var parser = parserWrapper(config.parser, options);
    var validator = (_c = config.validator) !== null && _c !== void 0 ? _c : (function () { });
    var executor = executorWrapper(config.executor, options);
    var errorHandler = (_d = config.errorHandler) !== null && _d !== void 0 ? _d : (function (error) {
        throw error;
    });
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    kill();
                    _a = data;
                    return [4 /*yield*/, authenticator(request)];
                case 2:
                    _a.context = _d.sent();
                    _b = data;
                    return [4 /*yield*/, parser(request, data.context)];
                case 3:
                    _b.parsed = _d.sent();
                    return [4 /*yield*/, validator(data.parsed, data.context, options)];
                case 4:
                    _d.sent();
                    _c = data;
                    return [4 /*yield*/, executor(data.parsed, data.context)];
                case 5:
                    _c.result = _d.sent();
                    return [2 /*return*/, respond(data.result, code)];
                case 6:
                    error_2 = _d.sent();
                    return [4 /*yield*/, errorHandler(error_2, data)];
