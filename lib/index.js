        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _a.rc = _d.sent();
                    _b = data;
                    return [4 /*yield*/, config.parser(request, data.rc)];
                case 3:
                    _b.parsed = _d.sent();
                    if (!(config.validator !== undefined)) return [3 /*break*/, 5];
                    return [4 /*yield*/, config.validator(data.parsed, data.rc, config.options)];
                case 4:
                    _d.sent();
                    _d.label = 5;
                case 5:
                    _c = data;
                    return [4 /*yield*/, config.executor(data.parsed, data.rc)];
                case 6:
                    _c.result = _d.sent();
