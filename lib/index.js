...
exports.handleUpdateOne = exports.handleSearch = exports.handleGetOne = exports.handleGetMany = exports.handleDeleteOne = exports.handleCreateOne = exports.handle = exports.getMin = exports.getMax = exports.fetchJsonOrThrow = void 0;
...
function handle(config) {
    ...
    return function (request) { return __awaiter(_this, void 0, void 0, function () {
        var rc, parsed, result, error_1, method, url, ec;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    rc = null;
                ...
                case 5:
                    ...
                    if (config.errorHandler === undefined) {
                        ...
                        return [2 /*return*/, config.errorHandler(error_1, ec)];
                    }
                    return [3 /*break*/, 6];
