...
exports.handleUpdateOne = exports.handleGetOneSafe = exports.handleGetOne = exports.handleGetMany = exports.handleDeleteOne = exports.handleCreateOne = exports.handle = exports.getMin = exports.getMax = exports.fetchJsonOrThrow = void 0;
...
function handleGetMany(config) {
    ...
    return handle(__assign(__assign({}, config), { validator: validator, executor: executor }));
}
...
function handleCreateOne(config) {
    ...
    return handle(__assign(__assign({}, config), { validator: validator, executor: executor, code: 201 }));
}
...
function handle(config) {
    ...
    return function (request) { return __awaiter(_this, void 0, void 0, function () {
        var rc, parsed, result, error_2, method, url, ec;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    rc = null;
                ...
                case 1:
                    _a.trys.push([1, 5, , 6]);
                    kill();
                    return [4 /*yield*/, config.authenticator(request.headers, config.options)];
                case 2:
                    rc = _a.sent();
                    return [4 /*yield*/, config.validator(request, rc)];
                case 3:
                    parsed = _a.sent();
                    return [4 /*yield*/, config.executor(parsed, rc)];
                case 4:
                    result = _a.sent();
                ...
                case 5:
                    ...
                    if (config.errorHandler === undefined) {
                        ...
                        ec = { method: method, url: url, rc: rc, parsed: parsed, result: result };
                        return [2 /*return*/, config.errorHandler(error_2, ec)];
                    }
                    return [3 /*break*/, 6];
